...
class Decensor(QtCore.QThread):
    ...
    def load_model(self):
        ...
        if self.model is None:
            ...
            self.model = InpaintNN(bar_model_name=bar_model,
    ...
    def decensor_image_variation(self, ori, colored, variant_number, file_name):
        ...
        for region_counter, region in enumerate(regions, 1):
            print("Decensoring regions in image, Decensoring censor {}/{}".format(region_counter, len(regions)))
            ...
            print("{region_counter} out of {region_count} regions decensored.".format(region_counter=region_counter,
