...
class Detector():
    ...
    def __init__(self, weights_path):
        ...
        try:
            ...
            print("ERROR in Detector init: Cannot find ESR_out or some dec_input within.")
            return
    ...
    def detect_and_cover(self, image_path=None, fname=None, save_path='', is_video=False, orig_video_folder=None, force_jpg=False, is_mosaic=False, dilation=0):
        ...
        if is_video: 
            ...
            try:
                ...
                print("ERROR in detect_and_cover: Image write. Skipping. image_path=", image_path, e)
    ...
    def run_on_folder(self, input_folder, output_folder, is_video=False, orig_video_folder=None, is_mosaic=False, dilation=0):
        ...
        if(is_video == True):
            ...
            for img_path, img_name in img_list:
                ...
                fin = time.perf_counter()
                total_time = fin-star
                print('Detection on image', file_counter + 1,'of', len(img_list),'finished in {:.4f} seconds'.format(total_time))
                file_counter += 1
